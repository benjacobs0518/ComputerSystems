 ...
 * @param message: the message to transmit*/
 void transmitMsg(city *head, string receiver, string message)
 {
     ...
     cout<< temp-> name << " [# messages passed: " << temp -> numberMessages<< "] received: " << message << endl;
     temp = temp->next;
...
city* loadDefaultSetup(city *head)
{
     ...
     head = addCity(NULL,NULL, "Los Angeles");
     city *prev = new city;
     prev = head;
     addCity(head,prev, "Phoenix");
     prev = head->next;
     addCity(head,prev, "Denver");
     prev = prev->next;
     addCity(head,prev, "Dallas");
     prev = prev->next;
     addCity(head,prev, "Atlanta");
     prev = prev->next;
     addCity(head,prev, "New York");
     prev = prev->next;
     return head;
}
